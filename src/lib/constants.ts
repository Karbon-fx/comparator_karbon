...
// Bank fee configuration - ADD THIS
export const BANK_FEES = {
  WITHDRAWAL_FEE_USD: 0.99, // $0.99 per transaction
} as const;

// PayPal fee configuration - ADD THIS (optional, for consistency)
export const PAYPAL_FEES = {
  TRANSACTION_PERCENTAGE: 4.4, // 4.4%
  TRANSACTION_FIXED_USD: 0.30, // $0.30
  CONVERSION_PERCENTAGE: 4.0, // 4%
} as const;
...
export const UI_TEXT = {
  LABELS: {
    ...
    BANK_CHARGES: 'Bank Charges',  // Add this
  ...
  TOOLTIPS: {
    ...
    WITHDRAWAL_FEE: 'Bank withdrawal fee charged per transaction',
